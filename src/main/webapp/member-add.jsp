...
<body>
<div class="x-body">
    <form class="layui-form" action="/psi/AddUserServlet">
        <div class="layui-form-item">
            ...
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>我只知道qq邮箱哦
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-form-mid layui-word-aux">
                <span class="x-red">*</span>输不够6个字符弄死你
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <input type="submit" class="layui-btn" lay-submit="" value="submit">
            </input>
        </div>
    </form>
</div>
